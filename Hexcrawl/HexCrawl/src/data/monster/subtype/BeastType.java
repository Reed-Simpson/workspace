...
public enum BeastType implements Species {
	ALBATROSS,ALLOSAURUS,ANKYLOSAURUS,ANT,APE,ARMADILLO,AUROCHS,AXE_BEAK,BABOON,BADGER,BAT,BEETLE,BIRD_OF_PARADISE,BLACK_BEAR,BLOOD_HAWK,BOAR,BRONTOSAURUS,BROWN_BEAR,BUTTERFLY,CAMEL,CAT,CENTIPEDE,
	CHAMELEON,COCKROACH,CONSTRICTOR_SNAKE,
	CRAB,CRANIUM_RAT,CROCODILE,DEEP_ROTHE,DEER,DEINONYCHUS,DIMETRODON,DIRE_WOLF,DOLPHIN,DRAFT_HORSE,EAGLE,ELEPHANT,ELK,FERRET,FLYING_SNAKE,FOX,FROG,GIANT_FIRE_BEETLE,GIRAFFE,GOAT,HADROSAURUS,HYENA,JACKAL,
	...
	/*
	 * ",,,Condor,Crane,Crow,Dragonfly,Falcon,Firefly,Flamingo,Fly,Flying squirrel,Goose,Gull,Hummingbird,Kingfisher,Locust,Magpie,Mantis,Mockingbird,Mosquito,"+
			"Moth,Parrot,Peacock,Pelican,Pteranodon,Rooster,Sparrow,Swan,Woodpecker"
			
			",,,,,,Mole,Ostrich,Ox,Porcupine,Rabbit,Raccoon,Sheep,Slug,Snail,Squirrel,Wolverine"
	...
	private static void populateHabitats() {
		habitats = new HashMap<BiomeType,WeightedTable<Species>>();
		{
			...
			Species[] array = new Species[] {OWL,BLOOD_HAWK,BROWN_BEAR,FOX,POLAR_BEAR,SABERTOOTHED_TIGER,MAMMOTH};
		...
		{
			WeightedTable<Species> list = new WeightedTable<Species>();
			Species[] array = new Species[] {ANT,ARMADILLO,BEETLE,CAT,CHAMELEON,FERRET,FOX,GIRAFFE,HYENA,JACKAL,SCORPION,VULTURE,CAMEL,FLYING_SNAKE,MULE,POISONOUS_SNAKE,STIRGE,CONSTRICTOR_SNAKE,LIZARD,
		...
		{
			WeightedTable<Species> list = new WeightedTable<Species>();
			Species[] array = new Species[] {ANT,BABOON,BADGER,BEETLE,BUTTERFLY,CAT,COCKROACH,DEER,HYENA,OWL,BLOOD_HAWK,FLYING_SNAKE,FOX,RAT,WEASEL,MASTIFF,POISONOUS_SNAKE,STIRGE,BOAR,CONSTRICTOR_SNAKE,ELK,
		...
		{
			WeightedTable<Species> list = new WeightedTable<Species>();
			Species[] array = new Species[] {ANT,ARMADILLO,BUTTERFLY,CAT,COCKROACH,DEER,EAGLE,FERRET,FOX,GIRAFFE,GOAT,HYENA,JACKAL,VULTURE,BLOOD_HAWK,FLYING_SNAKE,WEASEL,POISONOUS_SNAKE,STIRGE,AXE_BEAK,BOAR,ELK,
		...
		{
			WeightedTable<Species> list = new WeightedTable<Species>();
			Species[] array = new Species[] {ANT,BABOON,EAGLE,FOX,GOAT,HYENA,RAVEN,VULTURE,BLOOD_HAWK,WEASEL,MASTIFF,MULE,POISONOUS_SNAKE,STIRGE,AXE_BEAK,BOAR,ELK,OWL,
		...
		{
			WeightedTable<Species> list = new WeightedTable<Species>();
			Species[] array = new Species[] {ANT,ARMADILLO,BABOON,BEETLE,BIRD_OF_PARADISE,BUTTERFLY,CHAMELEON,COCKROACH,LIZARD,SPIDER,FLYING_SNAKE,POISONOUS_SNAKE,STIRGE,AXE_BEAK,CONSTRICTOR_SNAKE,FROG,
		...
		{
			WeightedTable<Species> list = new WeightedTable<Species>();
			Species[] array = new Species[] {ANT,EAGLE,FOX,GOAT,BLOOD_HAWK,STIRGE,PTERANODON,BAT,LION,AUROCHS,ELK,QUETZALCOATLUS,SABERTOOTHED_TIGER};
			for(Species s:array) list.put(s);
			habitats.put(BiomeType.MOUNTAINS, list);
		}
		{
			WeightedTable<Species> list = new WeightedTable<Species>();
			Species[] array = new Species[] {ANT,BEETLE,BUTTERFLY,COCKROACH,RAT,RAVEN,POISONOUS_SNAKE,STIRGE,CONSTRICTOR_SNAKE,DIMETRODON,FROG,LIZARD,HADROSAURUS,
		...
		{
			WeightedTable<Species> list = new WeightedTable<Species>();
			Species[] array = new Species[] {ANT,BEETLE,COCKROACH,CRANIUM_RAT,GIANT_FIRE_BEETLE,RAT,STIRGE,DEEP_ROTHE,BAT,CENTIPEDE,LIZARD,POISONOUS_SNAKE,
		...
		{
			WeightedTable<Species> list = new WeightedTable<Species>();
			Species[] array = new Species[] {BEETLE,CAT,COCKROACH,CRANIUM_RAT,FOX,GOAT,RAT,RAVEN,FLYING_SNAKE,MASTIFF,MULE,PONY,STIRGE,DRAFT_HORSE,CENTIPEDE,POISONOUS_SNAKE,OX,RIDING_HORSE,
